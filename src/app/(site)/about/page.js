        ...
        <div className="mx-auto w-full max-w-7xl space-y-12 px-4 py-12 sm:px-6 lg:px-8 lg:py-14">
            <section className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm sm:p-10">
                ...
                <p className="mt-4 max-w-3xl text-sm leading-relaxed text-zinc-600 sm:text-base">
                    We are focused on helping businesses discover premium
                    plywood, laminates, hardware and furniture solutions through
                    a clean catalog-first experience. Our process is designed
                    for fast discovery and direct WhatsApp enquiry without
                    checkout friction.
                </p>
            </section>
            ...
            <section className="grid gap-6 lg:grid-cols-3">
                <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-zinc-600">
                        Deliver dependable, high-quality materials with a
                        professional digital catalog that makes B2B inquiries
                        simple and fast.
                    </p>
                </div>
                <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-zinc-600">
                        A broad catalog across key product categories with clear
                        visuals, organized product details, PDF catalogs, and
                ...
                <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-zinc-600">
                        Browse categories and products, open detailed pages,
                        then send a prefilled WhatsApp enquiry instantly. No
                        cart, no checkout, only direct catalog discussions.
                    </p>
                </div>
            </section>
            ...
            <section>
                ...
                {highlights.length > 0 ? (
                    ...
                    <div className="rounded-2xl border border-zinc-200 bg-white p-8 text-sm text-zinc-600">
                        Category highlights will appear once categories are
                        added in Sanity.
                    </div>
                )}
            </section>
            ...
            <section className="rounded-3xl bg-zinc-900 p-8 text-white sm:p-10">
                ...
                <p className="mt-2 text-sm text-zinc-300">
                    Start browsing by category or jump straight into all
                    products.
                </p>
