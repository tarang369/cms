...
export async function generateMetadata() {
    ...
    return buildSeoMetadata({
        ...
        description:
            "Get in touch with Neptune Plywood Private Limited for catalog inquiries on WhatsApp.",
        path: "/contact",
    });
}
        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-14">
            <div className="mb-8 space-y-2">
                ...
                <p className="max-w-2xl text-sm text-zinc-600 sm:text-base">
                    Share your requirement and we will guide you to the right
            ...
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
                    ...
                    <div className="space-y-3 text-sm text-zinc-700">
                        <p>
                            ...
                            {phoneHref ? (
                                <a
                                    href={phoneHref}
                                    className="underline decoration-zinc-300 underline-offset-4 transition hover:text-zinc-950 hover:decoration-zinc-900"
                                >
                                    {phone}
                                </a>
                            ) : (
                ...
                <section className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8">
                    ...
                    <p className="mt-2 text-sm text-zinc-600">
                        This is a front-end form UI. Submissions are not
