...
export default function Footer({ siteSettings }) {
    ...
    const emailHref = createEmailHref("sales@neptuneplywood.com");
            ...
            <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.3fr_1fr_1fr] lg:px-8">
                <div className="space-y-4">
                    ...
                    <p className="max-w-md text-sm leading-relaxed text-zinc-300">
                        ...
                        solutions for projects that need reliability,
                        consistency and fast enquiry.
                    </p>
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-sm text-zinc-200">
                        ...
                        {phoneHref ? (
                            <a
                                href={phoneHref}
                                className="underline decoration-zinc-600 underline-offset-4 transition hover:text-white hover:decoration-white"
                            >
                                {phone}
                            </a>
                        ) : (
